...
NAKSHATRAS = [
    {"num": 1,  "name": "Ashwini",        "ru": "Ашвини",          "lord": "Кету",     "symbol": "Голова лошади"},
    {"num": 2,  "name": "Bharani",        "ru": "Бхарани",         "lord": "Венера",   "symbol": "Йони (лоно)"},
    {"num": 3,  "name": "Krittika",       "ru": "Криттика",        "lord": "Солнце",   "symbol": "Бритва / пламя"},
    {"num": 4,  "name": "Rohini",         "ru": "Рохини",          "lord": "Луна",     "symbol": "Колесница"},
    {"num": 5,  "name": "Mrigashira",     "ru": "Мригашира",       "lord": "Марс",     "symbol": "Голова оленя"},
    {"num": 6,  "name": "Ardra",          "ru": "Ардра",           "lord": "Раху",     "symbol": "Слеза / Алмаз"},
    {"num": 7,  "name": "Punarvasu",      "ru": "Пунарвасу",       "lord": "Юпитер",   "symbol": "Колчан со стрелами"},
    {"num": 8,  "name": "Pushya",         "ru": "Пушья",           "lord": "Сатурн",   "symbol": "Цветок лотоса"},
    {"num": 9,  "name": "Ashlesha",       "ru": "Ашлеша",          "lord": "Меркурий", "symbol": "Змея"},
    {"num": 10, "name": "Magha",          "ru": "Магха",           "lord": "Кету",     "symbol": "Королевский трон"},
    {"num": 11, "name": "Purvaphalguni",  "ru": "Пурва Пхалгуни",  "lord": "Венера",   "symbol": "Гамак / ложе"},
    {"num": 12, "name": "Uttaraphalguni", "ru": "Уттара Пхалгуни", "lord": "Солнце",   "symbol": "Кровать"},
    {"num": 13, "name": "Hasta",          "ru": "Хаста",           "lord": "Луна",     "symbol": "Рука / кулак"},
    {"num": 14, "name": "Chitra",         "ru": "Читра",           "lord": "Марс",     "symbol": "Жемчужина"},
    {"num": 15, "name": "Swati",          "ru": "Свати",           "lord": "Раху",     "symbol": "Молодой росток"},
    {"num": 16, "name": "Vishakha",       "ru": "Вишакха",         "lord": "Юпитер",   "symbol": "Украшенные ворота"},
    {"num": 17, "name": "Anuradha",       "ru": "Анурадха",        "lord": "Сатурн",   "symbol": "Лотос"},
    {"num": 18, "name": "Jyeshtha",       "ru": "Джьештха",        "lord": "Меркурий", "symbol": "Серьга / зонтик"},
    {"num": 19, "name": "Mula",           "ru": "Мула",            "lord": "Кету",     "symbol": "Связка корней"},
    {"num": 20, "name": "Purvashadha",    "ru": "Пурвашадха",      "lord": "Венера",   "symbol": "Веер / бивень слона"},
    {"num": 21, "name": "Uttarashadha",   "ru": "Уттарашадха",     "lord": "Солнце",   "symbol": "Слоновий бивень"},
    {"num": 22, "name": "Shravana",       "ru": "Шравана",         "lord": "Луна",     "symbol": "Три следа"},
    {"num": 23, "name": "Dhanishtha",     "ru": "Дхаништха",       "lord": "Марс",     "symbol": "Барабан"},
    {"num": 24, "name": "Shatabhisha",    "ru": "Шатабхиша",       "lord": "Раху",     "symbol": "Пустой круг"},
    {"num": 25, "name": "Purvabhadra",    "ru": "Пурвабхадра",     "lord": "Юпитер",   "symbol": "Меч / двуликий"},
    {"num": 26, "name": "Uttarabhadra",   "ru": "Уттарабхадра",    "lord": "Сатурн",   "symbol": "Змея в воде"},
    {"num": 27, "name": "Revati",         "ru": "Ревати",          "lord": "Меркурий", "symbol": "Барабан / рыба"},
]

GANAS = {
    "Devata":   [1, 5, 7, 8, 13, 15, 17, 22, 27],
...
def get_nk(sid):
    ...
    deg  = sid % NK_SIZE
    n    = NAKSHATRAS[idx]
    gana = next((g for g, ns in GANAS.items() if n["num"] in ns), None)
    return {**n, "pada": pada, "degrees_in_nakshatra": round(deg, 6), "gana": gana}
